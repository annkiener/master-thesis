...
The auditory script for the first implementation was finalized with orchestration logic to ensure a controlled playback of hallucinations. The audio clips, recorded in French, were refined to express a wider range of emotional tones, including confusion, fear, and aggression, and were set to play in a fixed sequence.
